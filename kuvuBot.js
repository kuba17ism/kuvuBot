    ...
    switch (command) {
        ...
        case '.help':
            ...
            const embed = new discord.RichEmbed()
                ...
                .addField('\u200b', '[.servers](javascript:;) - wyświetla serwery na których jest kuvuBot')
                .addField('\u200b', '[.react](javascript:;) <tekst> - bot reaguje tekstem na wiadomość')
                .addField('\u200b', '[.clever](javascript:;) <tekst> - cleverbot')
                .addField('\u200b', '[.cat <img/gif>](javascript:;) - wysyła zdjęcie kotka :3')
                .addField('\u200b', '[.status <mojang/mc> (<IP>)](javascript:;) - wyświetla status serwerów Mojang')
                .addField('\u200b', '\u200b')
